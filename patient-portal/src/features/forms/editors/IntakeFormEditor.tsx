...
import { useSubmitForm } from "@/features/tasks/hooks/use-tasks";
import type { FormDetail } from "@/features/tasks/api/tasks-api";

// Patient portal shim — the editor was built for the provider's
// FormRequest shape (camelCase). FormDetail (snake_case) covers the
// only fields the editor touches, so we narrow it inline.
type FormRequest = Pick<FormDetail, "id" | "data" | "status">;
import {
  INTAKE_LIMITS,
  emptyIntakeErrors,
  validateIntake,
